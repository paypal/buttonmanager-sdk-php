...
```
curl -k -L https://raw.githubusercontent.com/paypal/buttonmanager-sdk-php/stable/samples/install.php | php
        OR
wget  https://raw.githubusercontent.com/paypal/buttonmanager-sdk-php/stable/samples/install.php
php install.php
```
...
```bash
    ...
    cd samples
    curl  https://raw.githubusercontent.com/paypal/buttonmanager-sdk-php/stable/samples/install.php | php
		OR
    php install.php
```
...
```json
{
    ...
    "require": {
        "paypal/buttonmanager-sdk-php":"2.*"
    }
}
```
